...
# This is a wrapper for decca-treebank.py.  Read the README for
# details.
...
try:
    ...
    print "Usage: " + sys.argv[0] + " constituents.txt"
    sys.exit()
...
try:
    ...
    sys.stderr.write("\n\nError: Unable to open constituents file " + filtertries + "\n")
    sys.exit(1)
...
for unit in unitlist:
    print commands.getoutput("./decca-treebank.py -u "+str(unit) + " 2> variation" + str(unit) + ".txt") + "\n"
