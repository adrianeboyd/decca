...
# XSLT processing for TigerXML files
#
# This script addresses problems with applying XSLT stylesheets to large
# TigerXML corpus files.  Instead of reading in the entire corpus file,
# it applies an XSL stylesheet to each sentence found in a TigerXML
...
try:
  ...
  print "Usage: " + sys.argv[0] + " xsl-file tigerxml-file"
  sys.exit()
...
# read in sentence chunks from tigerxml file and process with xsl
insent = 0
xmldecl = ""
